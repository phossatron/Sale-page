...
### ลิงก์หน้าผู้ดูแล
```
https://phossatron.github.io/Sale-page/admin/?edit=beyond2026
```
- เปิดครั้งแรกด้วยลิงก์เต็ม (มี `?edit=…`) → ระบบจะจำไว้ในเบราว์เซอร์เครื่องนั้น ครั้งต่อไปเปิดแค่ `/admin/` ก็พอ
- หน้านี้ตั้ง `noindex` ไว้ Google จะไม่เก็บเข้าระบบค้นหา
- ใครเปิด `/admin/` โดยไม่มีคีย์ จะเห็นเป็นหน้าเว็บธรรมดา ไม่มีเครื่องมือใด ๆ
...
| `/admin/?edit=beyond2026` บนเว็บจริง | ✅ เห็นครบ (หน้าผู้ดูแล) |
